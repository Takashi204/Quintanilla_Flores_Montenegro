...
public class VentasPanel extends JPanel {
    ...
    private final JLabel lblSub = new JLabel("$0");
    private final JLabel lblIgv = new JLabel("$0");
    private final JLabel lblTot = new JLabel("$0");
    ...
    private void addProductFlow() {
        ...
        if (code != null && !code.isBlank()) {
            selected = nMemoryStore.findByCode(code.trim()).orElse(null);
            if (selected == null) {
        ...
        if (selected == null) {
            List<Product> all = nMemoryStore.allProducts();
            if (all.isEmpty()) {
